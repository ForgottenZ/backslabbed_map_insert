execute if entity @s[advancements={mcm:secrets/vineyard/vineyard=true}] unless items entity @s armor.head diamond_hoe[item_model="minecraft:hats/bowlerhat"] at @s run playsound minecraft:item.armor.equip_leather block @s ~ ~ ~ 3 0
execute if entity @s[advancements={mcm:secrets/vineyard/vineyard=true}] unless items entity @s armor.head diamond_hoe[item_model="minecraft:hats/bowlerhat"] run item replace entity @s armor.head with diamond_hoe[custom_data={no_drop_on_death:1b},item_model="minecraft:hats/bowlerhat",enchantments={levels:{binding_curse:1},show_in_tooltip:false},unbreakable={show_in_tooltip:false},custom_name='{"translate":"mcm.item.bowlerhat","color":"gray","italic":false}']
